...
#<?php echo $wow_opt["main_weather_div"] ?> .wow-link,
#<?php echo $wow_opt["main_weather_div"] ?> .wow-last-update {
    margin-top: 5px;
}
...
<?php
    $info_col = ($wow_opt["wind"] || $wow_opt["humidity"] || $wow_opt["dew_point"] || $wow_opt["pressure"] || $wow_opt["cloudiness"] || $wow_opt["precipitation"] || $wow_opt["visibility"] || $wow_opt["uv_index"]);
...
<?php echo $wow_html["container"]["start"]; ?>
    ...
    <div class="row">
        <div class="wow-current <?php echo $main_class ?>">
            ...
            <?php if ($wow_opt["wind"] || $wow_opt["humidity"] || $wow_opt["dew_point"] || $wow_opt["pressure"] || $wow_opt["cloudiness"] || $wow_opt["precipitation"] || $wow_opt["visibility"] || $wow_opt["uv_index"]) { ?>
                <?php if (!empty($info_class)) { ?>
                    </div>
                    <div class="<?php echo $info_class ?>">
                <?php } ?>
            	<?php echo '<p class="wow-infos-text">'; ?>
            	<?php if ($wow_opt["wind"]) echo $wow_html["svg"]["wind"] . 'Wind: <span class="wow-value">' . $wow_data["wind_speed"] . ' ' . $wow_data["wind_direction"] . '</span><br>'; ?>
            	<?php if ($wow_opt["humidity"]) echo $wow_html["svg"]["humidity"] .'Humidity: <span class="wow-value">' . $wow_data["humidity"] . '</span><br>'; ?>
            	<?php if ($wow_opt["dew_point"]) echo $wow_html["svg"]["dew_point"] .'Dew Point: <span class="wow-value wow-temperature">' . $wow_data["dew_point"] . '</span><br>'; ?>
            	<?php if ($wow_opt["pressure"]) echo $wow_html["svg"]["pressure"] .'Pressure: <span class="wow-value">' . $wow_data["pressure"] . '</span><br>'; ?>
            	<?php if ($wow_opt["cloudiness"]) echo $wow_html["svg"]["cloudiness"] .'Cloudiness: <span class="wow-value">' . $wow_data["cloudiness"] . '</span><br>'; ?>
            	<?php if ($wow_opt["precipitation"]) echo $wow_html["svg"]["precipitation"] .'Precipitation: <span class="wow-value">' . $wow_data["precipitation_1h"] . '</span><br>'; ?>
            	<?php if ($wow_opt["visibility"]) echo $wow_html["svg"]["visibility"] . 'Visibility: <span class="wow-value">' . $wow_data["visibility"] . '</span><br>'; ?>
            	<?php if ($wow_opt["uv_index"]) echo $wow_html["svg"]["uv_index"] . 'UV Index: <span class="wow-value">' . $wow_data["uv_index"] . '</span><br>'; ?>
            	<?php echo "</p>"; ?>
            <?php } ?>
